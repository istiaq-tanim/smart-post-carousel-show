...
function Style() {
	...
	return <>
		...
		{
			attributes.imageHoverEffectType === "opacity" && <CustomRangeControl
				label="Opacity"
		...
		<CustomRangeControl
			...
			attributeKey={
				attributes.imageEffect === "normal" ? "grayScaleNormalLevel" : "grayScaleHoverLevel"
			}
			min={0}
			max={100}
			defaultValue={0}
		...
		<CustomRangeControl
			label="Blur"
			attributeKey={
				attributes.imageEffect === "normal" ? "blurNormalLevel" : "blurHoverLevel"
			}
			min={0}
			max={20}
			defaultValue={0}
