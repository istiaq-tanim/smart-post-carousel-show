	...
	return (
		<div
			...
			style={{
				...
				"--button-margin": `${buttonMargin[normalizedDeviceType].top ?? 0}px ${buttonMargin[normalizedDeviceType].right ?? 0}px ${buttonMargin[normalizedDeviceType].bottom ?? 0}px ${buttonMargin[normalizedDeviceType].left ?? 0}px`,

				...(buttonType === "button" && {
					...(normalBg && { "--button-bg": normalBg }),
					...(hoverBg && { "--button-hover-bg": hoverBg }),
					"--button-border": buttonBorderStyle || "none",
					"--button-hover-border": buttonHoverBorderStyle === "none" ? buttonBorderStyle : buttonHoverBorderStyle,
					...
					"--button-border-radius": `${buttonBorderRadiusNormal?.[normalizedDeviceType] ?? 0}px`,
					"--button-hover-border-radius": `${buttonBorderRadiusHover?.[normalizedDeviceType] ?? 0}px`,
					"--button-padding": `${buttonPadding[normalizedDeviceType].top ?? 0}px ${buttonPadding[normalizedDeviceType].right ?? 0}px ${buttonPadding[normalizedDeviceType].bottom ?? 0}px ${buttonPadding[normalizedDeviceType].left ?? 0}px`,
				}),
			}}
		>
			<span
