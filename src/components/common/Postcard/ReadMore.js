	...
	return (
		<div
			...
			style={{
				...
				"--button-margin": `${buttonMargin[normalizedDeviceType].top ?? 0}px ${buttonMargin[normalizedDeviceType].right ?? 0
					}px ${buttonMargin[normalizedDeviceType].bottom ?? 0}px ${buttonMargin[normalizedDeviceType].left ?? 0
					}px`,
				...
				...(buttonType === "button" && {
					...
					"--button-border-radius": `${buttonBorderRadiusNormal?.[normalizedDeviceType] ?? 0
						}px`,
					"--button-hover-border-radius": `${buttonBorderRadiusHover?.[normalizedDeviceType] ?? 0
						}px`,
					"--button-padding": `${buttonPadding[normalizedDeviceType].top ?? 0
						}px ${buttonPadding[normalizedDeviceType].right ?? 0}px ${buttonPadding[normalizedDeviceType].bottom ?? 0
